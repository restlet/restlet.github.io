...
environements is available as well as an [Eclipse update site](/documentation/user-guide/{{% param version %}}/introduction/setup/download/?distribution=p2&release=stable&edition=osgi).
