...
[CookieSetting]({{ site.data.javadoc.baseUrl }}{{ page.version }}/jse/api/org/restlet/data/CookieSetting.html) objects
accessible from a [Request]({{ site.data.javadoc.baseUrl }}{{ page.version }}/jse/api/org/restlet/Request.html) or a
