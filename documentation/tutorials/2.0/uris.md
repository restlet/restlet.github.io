...
[Template]({{ site.data.javadoc.preMavenCentral.baseUrl }}{{ page.version }}/jse/api/org/restlet/routing/Template.html) class. The third
...
[Reference\#decode(String)]({{ site.data.javadoc.preMavenCentral.baseUrl }}{{ page.version }}/jse/api/org/restlet/data/Reference.html#decode(java.lang.String) "Reference#decode(String)")
method.
