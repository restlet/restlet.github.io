...
a Web application. There is a related [FAQ entry](/documentation/user-guide/2.3/appendices/faq#how-to-use-restlet-in-an-applet) that
...
entry](/documentation/user-guide/2.3/appendices/faq#how-do-i-implement-the-traditional-mvc-pattern).
