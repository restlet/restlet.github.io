...
Request,
Response)](/documentation/javadocs/{{ page.version }}/jse/api/org/restlet/service/StatusService.html#getStatus%28java.lang.Throwable,%20org.restlet.Request,%20org.restlet.Response%29)
...
[Status.SERVER\_ERROR\_INTERNAL](/documentation/javadocs/{{ page.version }}/jse/api/org/restlet/data/Status.html#SERVER_ERROR_INTERNAL)
constant will be set by default.

Also, when the status of a response returned is an error status (see
[Status.isError()](/documentation/javadocs/{{ page.version }}/jse/api/org/restlet/data/Status.html#isError%28%29),
the [getRepresentation(Status, Request,
Response)](/documentation/javadocs/{{ page.version }}/jse/api/org/restlet/service/StatusService.html#getRepresentation%28org.restlet.data.Status,%20org.restlet.Request,%20org.restlet.Response%29)
