...
-   [Server connectors](/documentation/user-guide/{{ page.version }}/core/base/connectors)
-   [Sample code of FileUpload extension (zip file)](/technical-resources/restlet-framework/archives/examples/fileupload/{{ page.version }}/sample.zip "Usage example of FileUpload extension")
