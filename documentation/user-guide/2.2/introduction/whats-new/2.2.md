...
as well as [the full list of changes](/documentation/2.2/changelog).
...
# Migration guide from version 2.1 to {{ page.version }}
...
Note that if you intend to migrate directly from 1.1 to {{ page.version }}, you should
...
Javadocs at the preferred alternative in version {{ page.version }}.
