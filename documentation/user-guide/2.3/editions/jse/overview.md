...
"[FirstStepsStandalone]({{ site.data.downloads.preMavenCentral.baseUrl }}technical-resources/restlet-framework/archives/examples/firstSteps/firstStepsStandalone.zip "firstStepsStandalone") (application/zip, 1.4 kB)"
file.
