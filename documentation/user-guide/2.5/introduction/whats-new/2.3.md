...
* **Restlet API refactoring**
  ...
  * [CORS (Cross-Origin Resource Sharing) headers support]({{ site.data.javadoc.preMavenCentral.baseUrl }}{{ page.version }}/jse/api/org/restlet/service/CorsService.html)
* **Removals**
  * Windows installers
