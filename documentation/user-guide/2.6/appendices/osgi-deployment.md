...
An archive of this test project is [available here]({{ site.data.downloads.preMavenCentral.baseUrl }}technical-resources/restlet-framework/archives/examples/osgi/{{ page.version }}/org.restlet.example.osgi.test.zip "OsgiUsageTest2") (application/zip, 7 kB).
...
<pre class="language-bash"><code class="language-bash">java -jar org.eclipse.osgi\_3.X.X.jar -console 7777 &
</code></pre>
...
<pre class="language-bash"><code class="language-bash">Internal Connector Error (1002) - No available client connector supports the
